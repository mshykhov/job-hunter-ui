...
import { Button, Card, Checkbox, Flex, Input, Switch, Typography } from "antd";
...
export const PreferencesForm = ({
  ...
  return (
    <Flex vertical gap={20}>
      ...
      <Card size="small" title="Seniority Levels">
        <TagListInput
      ...
      <Card size="small" title="Excluded Keywords">
        <Typography.Text type="secondary" style={{ fontSize: 12, display: "block", marginBottom: 8 }}>
