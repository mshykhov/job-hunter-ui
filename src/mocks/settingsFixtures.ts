  ...
  providers: [
    {
      ...
      recommended: true,
      models: [
        { id: "claude-opus-4-8", name: "Claude Opus 4.8", inputCostPer1M: 15, outputCostPer1M: 75, cachedInputCostPer1M: 1.5, contextWindow: 200000, recommended: true },
        { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", inputCostPer1M: 1, outputCostPer1M: 5, cachedInputCostPer1M: 0.1, contextWindow: 200000, recommended: false },
      ],
    },
    {
      id: "openai",
      ...
      recommended: false,
      models: [
        { id: "gpt-5", name: "GPT-5", inputCostPer1M: 10, outputCostPer1M: 30, cachedInputCostPer1M: null, contextWindow: 128000, recommended: false },
      ],
    },
  ],
};
